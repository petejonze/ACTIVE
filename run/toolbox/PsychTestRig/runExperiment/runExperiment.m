...
%  	if isempty(configIDs)
    ...
    try %wrap in try..catch to ensure that we will always properly finish up
        ...
        for i=1:configSelectionNumber
            ...
            if skipWriteCheck
                fprintf('[WARNING]: Note, you have opted to skip write checks. This allows for quicker program launch, but should only be used with care.\n');
            else
