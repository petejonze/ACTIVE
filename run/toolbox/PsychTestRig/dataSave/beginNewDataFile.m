...
% See also
    ...
    try
        ...
        headerInfo =    {  
                            '/*****HEADER INFORMATION*****/',...
                            strjoin1(',', 'Experiment ID:',expID),...
                            strjoin1(',', 'Participant ID:',num2str(partID)),...
                            strjoin1(',', 'Session ID:',num2str(sessID)),...
                            strjoin1(',', 'Block Num:',num2str(blockNum)),...
                            strjoin1(',', 'Config ID:',cfg.id),...
                            strjoin1(',', 'Manual ID:',''),...
                            '',...
                            strjoin1(',', 'Creation Date:',datestr(now,31)),...
                            strjoin1(',', 'End Date:',''),...
                            '',...
                            strjoin1(',', 'Config:',strCfg),...
                            strjoin1(',', 'Notes:',''),...
                            strjoin1(',', 'Warnings:',''),...
                            strjoin1(',', 'Errors:',''),...
                            '',...
