...
%                           
%                   0.8     @ 19-Oct-2017
%                           The first City edition
%                           * added runTimeParams to reduce the number
%                           expConfig files with only single-item
%                           differences
%                           [associated study = EyeCatcherLite]